...
const ImportAulasModal = ({ isOpen, onClose, onImportSuccess }) => {
  ...
  const handleImportExcel = async () => {
    ...
    try {
      const response = await Api.post("/import_aulas", formData, {
        headers: {
  ...
  const downloadTemplate = async () => {
    try {
      const response = await Api.get("/download_plantilla", {
        responseType: "blob",
      });
      ...
      link.href = url;
      link.setAttribute("download", "plantilla_aulas.xlsx");
      ...
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          <div className="modal-header bg-primary text-white">
            <h5 className="modal-title">Importar Aulas desde Excel</h5>
            <button
              type="button"
          ...
          <div className="modal-body">
            ...
            <div className="alert alert-info">
              ...
              <ul className="mb-0">
                ...
                <li>
                  <strong>numero</strong> (ej: 101, 205, 310) - Solo números
                </li>
                <li>
                  <strong>sede</strong> (ej: SEDE CENTRAL, SEDE NORTE)
                </li>
                <li>
                  <strong>aula</strong> (opcional - si no viene, se genera
                  automáticamente)
                </li>
              </ul>
            </div>
...
export default ImportAulasModal;
