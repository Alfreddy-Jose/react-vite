...
const columns = [
  ...
  ...(permisos.includes("editar laboratorio") || permisos.includes("eliminar laboratorio")
    ? [
        {
          name: "ACCIONES",
          cell: (row) => (
...
export default function Laboratorios() {
  ...
  <>
        ...
        <ContainerTable
          ...
          link={ permisos.includes('crear laboratorio') ? (<Create path="/laboratorio/create" />) : null}
          // Tabla
